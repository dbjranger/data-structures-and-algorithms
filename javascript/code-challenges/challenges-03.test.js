...
const typeNum = (arr) => {
  // Solution code here...
  let answer = arr.filter(element => typeof element === 'number');
  return answer;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let answer = arr.filter(element => element.includes('and'));
  return answer;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let answer = arr.filter(element => element % 2 !== 0);
  return answer;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let answer = arr.filter((forbiddenValue) => !forbiddenValue.includes(arr));
  return answer;
};
